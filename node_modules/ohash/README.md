...
> ohash v1 docs and [release notes](https://github.com/unjs/ohash/releases/tag/v2.0.1) for
> migration.
...
> it is not designed for security purposes. Keep in mind that there is always a chance of
> intentional
