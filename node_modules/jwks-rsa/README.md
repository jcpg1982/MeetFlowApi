...
- [Examples](https://github.com/auth0/node-jwks-rsa/blob/master/EXAMPLES.md) - documentation of the
  options and code samples for common scenarios.
...
Supports all currently registered JWK types and JWS Algorithms,
see [panva/jose#262](https://github.com/panva/jose/issues/262) for more information.
...
We appreciate feedback and contribution to this repo! Before you get started, please see the
following:
...
please [raise an issue on our issue tracker](https://github.com/auth0/node-jwks-rsa/issues).
