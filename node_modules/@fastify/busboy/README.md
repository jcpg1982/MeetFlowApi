...
* **file**(< _string_ >fieldname, < _ReadableStream_ >stream, < _string_ >filename, < _string_ >
  transferEncoding, < _string_ >mimeType) - Emitted for each new file form field found.
  `transferEncoding` contains the 'Content-Transfer-Encoding' value for the file stream. `mimeType`
...
* **(constructor)**(< _object_ >config) - Creates and returns a new Busboy instance.
    ...
    * The constructor takes the following valid `config` settings:
        ...
        * **isPartAFile** - __function__ - Use this function to override the default file detection
          ...
          * contentType - __string__ The content-type of the part, e.g. `text/plain`,
